...
window.setTimeout(function() { $(".alert-error").alert('close'); }, 10000);
});
...
function addInputListItem(button, prefix) {
  ...
  // Because using .each busts things if you have lists within lists.
  var instanceTop = $('.inputListInstance', listTop).first();
  if ( instanceTop ) {
